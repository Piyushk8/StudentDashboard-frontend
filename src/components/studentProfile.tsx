...
interface ContestStats {
  ...
  ratingGraph: { time: string; rating: number; contest: string; rank: number }[];
  avgRating: number;
  avgRank: number;
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const recentProblemsRes = await getStudentRecentProblems(id, problemFilter);
          ...
          <div className="p-6 lg:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <p className="text-2xl font-bold">{contestStats.totalContests}</p>
              </div>
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                ...
                <p className="text-2xl font-bold">{contestStats.totalProblemsSolved}</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold">Rating Improvement</h3>
                <p className="text-2xl font-bold">{contestStats.ratingImprovement}</p>
              </div>
